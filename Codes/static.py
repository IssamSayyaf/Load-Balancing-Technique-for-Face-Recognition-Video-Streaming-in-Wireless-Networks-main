...
class ProjectController(app_manager.RyuApp):
    ...
    def link_add_handler(self, ev):
        ...
        self.update_graph()
        # self.adjacency[str(s1_dpid)][str(s2_dpid)] = s1.port_no
        # self.adjacency[str(s2_dpid)][str(s1_dpid)] = s2.port_no
    ...
    def get_dijkstra_path(self, src, dst):
        ...
        path = nx.bellman_ford_path(self.net, src, dst, weight='weight')
        return path
